...
FBgg0001085	BMP-C	BMP Signaling Pathway Core Components	FBgg0001086	BMP-MAD	FBgn0024179	wit
FBgg0001085	BMP-C	BMP Signaling Pathway Core Components	FBgg0001086	BMP-MAD	FBgn0003396	shn
FBgg0001085	BMP-C	BMP Signaling Pathway Core Components	FBgg0001086	BMP-MAD	FBgn0003716	tkv
FBgg0001085	BMP-C	BMP Signaling Pathway Core Components	FBgg0001086	BMP-MAD	FBgn0039914	mav
FBgg0001085	BMP-C	BMP Signaling Pathway Core Components	FBgg0001086	BMP-MAD	FBgn0003169	put
FBgg0000912	SWH-P	Positive Regulators of Hippo Signaling Pathway	FBgg0000917	SWH	FBgn0263395	hppy
FBgg0000912	SWH-P	Positive Regulators of Hippo Signaling Pathway	FBgg0000917	SWH	FBgn0032221	Schip1
...
class PathwayGeneGroupAdapter(Adapter):
    ...
    def __init__(self, write_properties, add_provenance, dmel_filepath=None, dmel_groups_hgnc_filepath=None):
        ...
        self.label = 'pathway_gene_group'
        #self.dataset = 'pathway_gene_group_dataset'
        self.type = 'PathwayGeneGroup'
        self.source = 'FLYBASE'
        self.source_url = 'https://flybase.org/'

        super(PathwayGeneGroupAdapter, self).__init__(write_properties, add_provenance)
        ...
        for i in range(0, len(rows)):
            ...
            if (i < len(rows) - 1) and (group_id == rows[i + 1][0]):
                ...
                try:
                    ...
                    hgnc_id= None
                if hgnc_id != None:
                    props['HGNC_family_ID'] = hgnc_id # @todo this should be a human gene grop
